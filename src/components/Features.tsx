      ...
      <div className="container mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Nossa API oferece todas as ferramentas necessárias para gerenciar
            seu relacionamento com clientes de forma eficiente.
          </p>
        </div>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <Feature
            icon={
              <UsersIcon color="#1fa2bd" className="h-8 w-8 text-bittersweet" />
            }
          ...
          <Feature
            icon={
              <TrendUpIcon
                color="#1fa2bd"
                className="h-8 w-8 text-bittersweet"
              />
            }
